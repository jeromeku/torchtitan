...
class Qwen3MoeSparseMoeBlock(nn.Module):
    ...
    def __init__(self, config: Qwen3MoeConfig):
        ...
        hidden_dim, intermediate_dim = config.embed_dim, config.expert_intermediate_dim
    ...
    def run_experts(self, x: torch.Tensor, router_outputs: RouterOutputs):
        ...
        x = self.experts(x, router_outputs.num_tokens_per_expert)
    ...
    # TODO: add torchtitan permute indices kernel
